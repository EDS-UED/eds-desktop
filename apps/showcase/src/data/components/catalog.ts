    ...
    items: [
      ...
      },
      {
        ...
        children: catalogFamilyBodyAndScenes(
          ...
          'popover-scenes',
          [
            { id: 'popovers-scene-guidance', label: '引导' },
            { id: 'popovers-scene-remark', label: '备注' },
            { id: 'popovers-scene-gas-fee', label: '矿工费' },
            { id: 'popovers-scene-confirm', label: '二次确认' },
          ],
        ),
      },
      {
      ...
      },
      {
        ...
        children: catalogFamilyBodyAndScenes(
          ...
          'tag-scenes',
          [
            { id: 'tag-scene-status', label: '状态' },
            { id: 'tag-scene-colorful', label: '彩色' },
            { id: 'tag-scene-palette', label: '业务' },
          ],
        ),
      },
      {
      ...
      },
      {
        ...
        children: catalogFamilyBodyAndScenes(
          ...
          'dialog-scenes',
          [
            { id: 'dialog-scene-symbol', label: '带符号的对话' },
            { id: 'dialog-scene-compose', label: '业务对话' },
          ],
        ),
      },
      {
        ...
        items: [
          {
            name: 'Verify',
            slug: 'verify',
            description: 'Security verification steps for sensitive operations.',
            status: 'implemented',
            children: catalogFamilyBodyAndScenes(
              catalogBody('verify', 'Verify'),
              'verify-scenes',
              [
                { id: 'verify-scene-email', label: '邮箱验证' },
                { id: 'verify-scene-google', label: 'Google 验证' },
                { id: 'verify-scene-login-password', label: '登录密码' },
                { id: 'verify-scene-transaction-password', label: '交易密码' },
                { id: 'verify-scene-passkey', label: '通行密钥' },
                { id: 'verify-scene-locked', label: '账户锁定' },
              ],
            ),
          },
        ],
